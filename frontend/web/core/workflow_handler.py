...
class WorkflowHandler:
    ...
    async def execute_workflow_logic(
        ...
        try:
            ...
            if StopException is None or not isinstance(e, StopException):
                raise
        ...
        try:
            ...
            async for event in self.executor_manager.execute_workflow(
                ...
                if st.session_state.get("cancel_workflow", False):
                ...
                try:
                    ...
                    if "on_error" in ui_callbacks:
                        ui_callbacks["on_error"](execution_result["error_message"])
                    break
            
            # 실행 결과 설정
            execution_result.update({
                "success": not bool(execution_result.get("error_message")),
